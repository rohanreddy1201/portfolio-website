      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-20 relative">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Architecting Generative AI &{" "}
            <span className="text-primary">Cloud Platforms</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            AI Cloud Engineer specializing in end-to-end AWS platforms, LLM applications, and MLOps. Proven ability to bridge scalable infrastructure with cutting-edge machine learning systems.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-start mb-16">
          ...
          <Card className="lg:col-span-2 p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground leading-relaxed">
              With industry experience at Oracle and Fipsar, I bring a unique blend of cloud-native engineering and applied AI. I’ve deployed LLM-based platforms, implemented generative AI search tools, and architected multi-stage AWS environments from scratch.
              <br /><br />
              I hold multiple AWS certifications and hold academic experience as a Reinforcement Learning TA. My projects like AutoMeet and ResumeLens tackle real-world inefficiencies through practical GenAI, vector DBs, and serverless architectures.
            </p>
          </Card>
