      ...
      <div className="container mx-auto px-4 py-24">
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Rohan Loganathan Reddy</h1>
              <p className="text-xl text-muted-foreground mb-4">
                ML/AI Engineer & Cloud Solutions Engineer
              </p>
              <div className="flex flex-wrap gap-2">
                ...
                <Badge variant="outline" className="bg-primary/10">
                  <Building2 className="w-3 h-3 mr-2" /> AI Cloud Engineer
                </Badge>
                <Badge variant="outline" className="bg-primary/10">
        ...
        >
          <Card className="p-8 backdrop-blur-xl bg-card/50 border-primary/10">
            ...
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
              <p>
                I’m Rohan Loganathan Reddy, an AI Cloud Engineer at Fipsar, where I lead infrastructure and deployment for intelligent applications built on top of modern LLM stacks. 
                My work blends end-to-end machine learning with scalable cloud infrastructure — enabling real-world AI tools to go from idea to production.
              </p>
              <p>
                I’ve deployed AI applications using <strong>AWS ECS, Fargate, Lambda, API Gateway, Route 53, and Secrets Manager</strong> — 
                supporting internal enterprise AI tools powered by <strong>OpenAI APIs</strong> and fast inference APIs using <strong>FastAPI</strong>. 
                From embedding-based document search to LangChain-powered chatbots, I build platforms that scale intelligently and securely.
              </p>
              <p>
                I hold a Master’s in Computer Science with a specialization in Machine Learning & Artificial Intelligence from Portland State University. 
                I also bring past experience at <strong>Oracle</strong> as a BI Engineer, and academic research in ML/IR systems. 
                My technical skills span <strong>Python, C++, SQL, Docker, GitHub Actions, FastAPI</strong>, and cloud-native engineering across the AWS ecosystem.
              </p>
              <p>
                I’m certified by AWS (ML Specialty), Hackerrank (Software + SQL), and Databricks (Lakehouse + GenAI). 
                But what drives me is practical creativity — building usable systems with thoughtful design, not just working code.
              </p>
            </div>
          </Card>
        </motion.div>
